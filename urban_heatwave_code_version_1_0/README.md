...
1. `01_main_pair_period_metrics_common_time_dew2harm_fixed.py`  
...
- `5_climatezone_uhi_uci_hw_nhw_method_freeze_final.py`
- `6_uhi_uci_hw_warmseason_integrated_analysis_v4_method_freeze_final.py`

### Figure preparation and plotting

- `1_plot_result_fig1_method_freeze_final.py`
- `2_plot_results_fig23_method_freeze_final.py`
- `3_prepare_ncc_diurnal_paired_hw_summary_method_freeze_final.py`
- `4_plot_fig4_paired_hw_summary_method_freeze_final.py`
- `8_plot_sensitivity_analysis_v7_nature.py`
