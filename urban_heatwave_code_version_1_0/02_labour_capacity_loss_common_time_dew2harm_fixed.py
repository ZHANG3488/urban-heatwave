...
Dew-point policy:
  Use only dew-point values already present in the input dataset.
  No fixed-RH fallback, interpolation, ERA5, or other supplementary data.
  Missing dew-point values remain NaN and propagate to WBGT/labour outputs.
"""
